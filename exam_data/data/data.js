...
export const questions_zh = [
	...
	"我并不会读<b>每一篇</b>看到的社论。<br>译注：社论指一种带有指导性观点意见的新闻评论。",
	"我认为我的生活没有走在正道上。<br>译注：指道德、正当性、生活方式等而非成就感。",
	...
	"我喜欢诗歌。",
	"有时我会捉弄动物。",
	"我想我会喜欢类似护林员的工作。<br>译注：此处着重点是工作方式，例如独自坐在瞭望塔里、在森林里走动、细心观察四周。",
	"我容易在争论中被说服。<br>译注：此处有“客观上对方是正确的”这一前提。",
	"最近我感到执着于有所作为很难。",
	"有时我的灵魂离开了我的身体。",
	"我确信我缺乏自信。",
	"我希望成为一名园丁。",
	...
	"我想成为一名护士。",
	"我认为大多数人都会为了成功而撒谎。",
	"有很多事，我做完就后悔了。（我看起来比别人更经常后悔）",
	"我很少和家人吵架。<br>译注：这里是 quarrel。<br>" +
	"argue：指提出理由或证据为自己或自己一方的看法或立场辩护，着重说理、论证和企图说服。<br>" +
	"quarrel：指两人之间或两个团体之间不友好的、吵吵嚷嚷地大声争论某事，尤指\"吵嘴、吵架\"。<br>" +
	...
	"很多时候，我感觉自己似乎做了错事或坏事。",
	"我总是很开心。",
	"我能看到其他人看不到的人、事、物。<br>译注：此处并不是指别人没有你那么细心观察细节",
	"我总是觉得头胀鼻塞。",
	...
	"我经常觉得受了紧箍咒一般。",
	"有时我也会生气。",
	"如果我能下注，我会对比赛或游戏更感兴趣。<br>译注：不要和‘比赛或游戏’之外的对象比较",
	"大多数人诚实的主要原因是害怕被戳穿。",
	"我曾因为不良行为在学校里被领导约谈。",
	...
	"我的脑子有点毛病。",
	"我没有过气喘或花粉过敏的症状。",
	"我曾在保持清晰认知的情况下无法控制自己的行为或言语。<br>译注：你不想这么做，但还是在做",
	"不是所有我认识的人我都喜欢。",
	"我几乎不做白日梦。",
	"我希望我不是如此害羞。",
	"我不怕管钱。",
	...
	"我喜欢许多不同种类的娱乐活动。",
	"我享受暧昧互动的乐趣。<br>AI注：你是否享受那种“由于性魅力或性格魅力而产生的社交张力”？",
	...
	"我的一些家庭成员有着令我恼火的习惯。",
	"有时我异常轻松地做出了决定。",
	"我愿意加入一些社团或组织。<br>AI注：你是否渴望与一群志同道合的人建立正式或半正式的联系。",
	"我很少注意到自己的心跳，也很少气短。",
	"我喜欢谈论性。",
	"我喜欢去我没去过的地方。",
	...
	"我很容易生气，也很容易释怀。",
	"我已经独立，不受家庭约束。",
	"我经常耿耿于怀。<br>AI注：一件事情（通常是不愉快的）已经过去了，但你的大脑像复读机一样不停地重播当时的细节，并想“要是我那样做就好了”。",
	"有人一直想抢劫我。",
	"我大部分的亲戚都理解并支持我。",
	"我有时坐立不安，无法安坐。",
	"我曾对爱情失望。",
	...
	"我身上几乎没有哪里痛。",
	"我的做事方式容易引起他人的误解。",
	"有时毫无原因的，甚至在把事情搞砸了之后，我会感到狂喜，仿佛站在世界之巅。",
	"我不责怪贪婪的人。",
	"我认为有人想窃取我的想法和主意。",
	"我曾经有过思维空白，不知道该做什么，也不知道周围在发生什么。",
	"即使某些人在我眼里是三观不正/不道德/错误的，我依然<i>能</i>对他们保持客气和友好。",
	"我喜欢和互相开玩笑的人在一起。",
	"在选举中，有时我会把票投给我不熟悉的人。",
	"开始去做一件事情对我来说是困难的。",
	"我认为我是一个应该被（出于道义而）谴责的人。",
	"我在学校学东西很慢。",
	"如果我是一个艺术家，我愿意画花草。",
	"就算我不好看，我也不会因此困扰。",
	"我即使在天气凉爽时也容易出汗。",
	...
	"每周一次或多次，我会变得非常兴奋。",
	"一到人群中，我就不知道该说什么。",
	"我情绪低落时，令人兴奋的事情几乎总能使我心情好转。",
	"我不会在出门时担心门窗是否锁好。",
	"我认为我有难以饶恕的过错。",
	"我的皮肤有部分麻木。",
	"如果有人利用了轻信他人的人，我不会责怪他（利用别人的人）。",
	"在过去的几年里，我的视力变化不大。",
	...
	"我不喜欢身边有人。",
	"有人说我会梦游。",
	"对贵重物品不加保护，从而提供诱惑的人和偷窃者一样，都要为其失窃承担责任。<br>注：重点是承担责任，字面意思",
	"我想几乎所有人都会为了不惹麻烦而撒谎。",
	"我比大多数人更敏感。",
	"大多数人内心都不喜欢尽力帮助别人。",
	"我的很多梦都和性有关。",
	...
	"我经常绕路以避免遇到认识的人。",
	"我经常感觉事物不真切。",
	"比起看科普文章、深度解析等，我更喜欢刷短视频。",
	"我经常想无意义地数一些东西，例如灯牌上的灯数。",
	"我没有真的想伤害我的仇人。",
	"面对比我想象中更友好的人时，我往往会保持警惕。",
	"我有一些奇特和古怪的想法。<br>例如：红绿灯给我脑中的芯片发送了信号，所以我不闯红灯。",
	"当我必须离家短途旅行时，我就会焦虑不安。",
	"凡是我做的事情，我都期望成功。",
	"我一个人的时候会听到奇怪的声音。",
	"我一直害怕一些不会伤害我的人或物。",
	...
	"几乎每天都有使我害怕的事情发生。",
	"有时我充满活力。",
	"我对打击、批评或挫折反应极其剧烈、难以释怀。<br>我很容易把事情“往心里去”。",
	"有时我会享受被我爱的人所伤害。",
	"经常有人对我说侮辱性的话语。",
	"我在室内会感到不适。",
	"我通常在人前不怎么感到局促、害羞或不自然。<br>我不太在意别人的眼光。",
	"有人控制了我的思想。",
	...
	"如果有机会，我会成为一个好的领导者。",
	"我对低俗的故事感到尴尬。",
	"人是双标的，他们通常要求别人尊重他们的权利，却不愿给予他人同样的尊重。",
	"我喜欢社交聚会，只是为了和大家在一起。",
	"我记下有趣的故事，把它们讲给别人听。",
...
export const rin = [
	...
	[
		["TRIN", "True Response Inconsistency", 9],
		[
			[3, "T", 39, "T", 1],
			[12, "T", 166, "T", 1],
			[40, "T", 176, "T", 1],
...
export const tScoreCategories = [["", "美国常模"], ["CN200X", "中国常模新(无校正)"], ["CN1982", "中国常模1982版"]];
...
export const scales = [
	...
	[
		...
		[8.78, 4.75, 0.5, 15.42, 4.79],
		[9.83, 4.98, 0.5, 16.35, 4.95],
	],
	[
		["2", "抑郁", "Depression"],
	...
	[
		...
		[18.98, 4.36, 0.4, 24.38, 4.27],
		[18.29, 4.45, 0.4, 23.33, 4.44],
	],
	[
	...
	[
		...
		[17.86, 7.93, 1.0, 31.14, 5.71],
		[18.77, 7.82, 1.0, 31.17, 5.86],
	],
	[
		...
		[23.01, 10.15, 1.0, 36.47, 8.24],
		[22.5, 9.57, 1.0, 34.89, 7.63],
	],
	[
		["9", "轻躁狂", "Hypomania"],
		...
		[18.48, 5.26, 0.2, 21.22, 4.88],
		[16.64, 5.16, 0.2, 19.18, 4.89],
	],
	[
